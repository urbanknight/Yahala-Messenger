...
public class TLRPC {
    ...
    public static class TL_peerUser extends Peer {
        ...
        public void readParams(AbsSerializedData stream) {
            user_id = stream.readString();
        }

        public void serializeToStream(AbsSerializedData stream) {
            stream.writeInt32(constructor);
            stream.writeString(user_id);
        }
    }
    ...
    public static class TL_peerChat extends Peer {
        ...
        public void readParams(AbsSerializedData stream) {
            chat_id = stream.readString();
        }

        public void serializeToStream(AbsSerializedData stream) {
            stream.writeInt32(constructor);
            stream.writeString(chat_id);
        }
    }
    ...
    public static class TL_messageMediaPhoto extends MessageMedia {
        ...
        public void readParams(AbsSerializedData stream) {//795019691
    ...
    public static class TL_message extends Message {
        ...
        public void readParams(AbsSerializedData stream) {
            ...
            message = stream.readString();
            media = (MessageMedia) TLClassStore.Instance().TLdeserialize(stream, stream.readInt32());
            if ((media != null && !(media instanceof TL_messageMediaEmpty) && message != null && message.length() != 0 && message.equals("-1"))) {
                attachPath = stream.readString();
            }
        }
