...
import com.yahala.ui.Views.FrameLayoutFixed;
import com.yahala.ui.Views.PopupAudioView;
...
public class PopupNotificationActivity extends Activity implements NotificationCenter.NotificationCenterDelegate {
    ...
    private BackupImageView2 avatarImageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatActivityEnterView.setDelegate(new ChatActivityEnterView.ChatActivityEnterViewDelegate() {
            ...
            public void onMessageSend() {
                ...
                MessagesStorage.getInstance().updateUnreadMessages(currentMessageObject.getDialogId());
        ...
        actionBarLayer.setBackgroundResource(R.color.SkyBlue2);
        ...
        avatarImageView = (BackupImageView2) view.findViewById(R.id.chat_avatar_image);
    ...
    public boolean onTouchEventMy(MotionEvent motionEvent) {
        ...
        if (motionEvent != null && motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (moveStartX != -1 && !startedMoving) {
                if (Math.abs(diff) > OSUtilities.dp(10)) {
                    startedMoving = true;
                    moveStartX = x;
                    OSUtilities.lockOrientation(this);
                    diff = 0;
            ...
            if (motionEvent != null && startedMoving) {
                ...
                int width = OSUtilities.displaySize.x - OSUtilities.dp(24);
                int moveDiff = 0;
                int forceMove = 0;
                View otherView = null;
                if (velocityTracker != null) {
                ...
                if ((forceMove == 1 || diff > width / 3) && leftView != null) {
                    ...
                    onAnimationEndRunnable = new Runnable() {
                        ...
                        public void run() {
                            ...
                            OSUtilities.unlockOrientation(PopupNotificationActivity.this);
                        }
                    };
    ...
    private void applyViewsLayoutParams(int xOffset) {
        ...
        int widht = OSUtilities.displaySize.x - OSUtilities.dp(24);
        if (leftView != null) {
    ...
    private ViewGroup getViewForMessage(int num, boolean applyOffset) {
        ...
        if (messageObject.type == 1) {
            ...
            BackupImageView2 imageView = (BackupImageView2) view.findViewById(R.id.message_image);
            ...
            public boolean onPreDraw() {
                ...
                if (!checkTransitionAnimation() && !startedMoving) {
                    ...
                    if (!Utilities.isTablet(PopupNotificationActivity.this) && PopupNotificationActivity.this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
                        layoutParams.topMargin = OSUtilities.dp(40);
                    } else {
    ...
    private void openCurrentMessage() {
        ...
        String dialog_id = currentMessageObject.getDialogId();
        if (dialog_id != "0") {
            /*int lower_id = (int)dialog_id;
            if (lower_id < 0) {
                intent.putExtra("chatId", -lower_id);*/
            // }else {
            intent.putExtra("user_jid", dialog_id);
            // }
        }
    ...
    private void updateInterfaceForCurrentMessage(int move) {
        ...
        if (dialog_id != "0") {
          /*  int lower_id = (int)dialog_id;
            ...
            currentUser = ContactsController.getInstance().friendsDict.get(currentMessageObject.messageOwner.getJid());
            //  }
        }
        ...
        if (currentChat != null && currentUser != null) {
            ...
            if (dialog_id == "0") {
                actionBarLayer.setTitleIcon(R.drawable.ic_lock_white, OSUtilities.dp(4));
            } else {
                actionBarLayer.setTitleIcon(0, 0);
            }
        }
