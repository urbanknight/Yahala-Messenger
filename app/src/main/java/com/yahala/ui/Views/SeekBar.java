...
public class SeekBar {
    ...
    public SeekBar(Context context) {
        if (thumbDrawable1 == null) {
            thumbDrawable1 = context.getResources().getDrawable(R.drawable.player2);
            thumbDrawablePressed1 = context.getResources().getDrawable(R.drawable.player2_pressed);
            ...
            innerPaint1.setColor(0xffd9e2eb);
            outerPaint1.setColor(0xff86c5f8);
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawRect(thumbWidth / 2, height / 2 - OSUtilities.dp(1), width - thumbWidth / 2, height / 2 + OSUtilities.dp(1), inner);
        canvas.drawRect(thumbWidth / 2, height / 2 - OSUtilities.dp(1), thumbWidth / 2 + thumbX, height / 2 + OSUtilities.dp(1), outer);
