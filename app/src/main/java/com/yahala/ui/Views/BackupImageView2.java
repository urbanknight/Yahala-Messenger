...
public class BackupImageView2 extends View {

    public ImageReceiver imageReceiver;
    public boolean processDetach = true;

    public BackupImageView2(Context context) {
        super(context);
        init();
    }

    public BackupImageView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BackupImageView2(Context context, AttributeSet attrs, int defStyleAttr) {
