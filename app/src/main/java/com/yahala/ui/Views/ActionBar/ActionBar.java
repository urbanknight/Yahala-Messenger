...
public class ActionBar extends FrameLayout {
    ...
    public void setCurrentActionBarLayer(ActionBarLayer layer) {
        ...
        currentLayer = layer;
        addView(layer);
        LayoutParams layoutParams = (LayoutParams) layer.getLayoutParams();
    ...
    public void prepareForMoving(ActionBarLayer layer) {
        ...
        layoutParams.height = LayoutParams.MATCH_PARENT;
        layer.setLayoutParams(layoutParams);
        shadowView.setX(-OSUtilities.dp(2));
    ...
    public void moveActionBarByX(int dx) {
        ...
        shadowView.setX(dx - OSUtilities.dp(2));
        if (dx != 0) {
            if (previousLayer != null) {
    ...
    public void setupAnimations(ArrayList<Animator> animators, boolean back) {
        if (back) {
            ...
            animators.add(ObjectAnimator.ofFloat(shadowView, "x", -OSUtilities.dp(2)));
            ...
            animators.add(ObjectAnimator.ofFloat(shadowView, "x", getMeasuredWidth() - OSUtilities.dp(2)));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(OSUtilities.dp(40), MeasureSpec.EXACTLY));
        } else {
            super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(OSUtilities.dp(48), MeasureSpec.EXACTLY));
        }
    }
