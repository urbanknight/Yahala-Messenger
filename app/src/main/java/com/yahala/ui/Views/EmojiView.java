...
public class EmojiView extends LinearLayout {
    ...
    private class EmojiGridAdapter extends BaseAdapter {
        ...
        public View getView(int paramInt, View paramView, ViewGroup paramViewGroup) {
            ...
            if (paramView != null) {
                ...
                localObject.setScaleType(ImageView.ScaleType.CENTER_CROP);
            }
    ...
    private class EmojiPagesAdapter extends PagerAdapter implements PagerSlidingTabStripEmoji.IconTabProvider {
