...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.background_tab_m;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabDeactivateTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_deactivateTextColor, tabDeactivateTextColor);
    ...
    public void setUnreadIconVisibility(int visible, int position) {
        ((IconButton) tabsContainer.getChildAt(position)).setNewUpdateImageVisibility(visible);
        FileLog.e("sd", "getChildAt(position)" + position + " tab text:" + ((IconButton) tabsContainer.getChildAt(position)).textView.getText());

    }

    private void addIconTab(final int position, int resId, String title) {

        IconButton tab = new IconButton(getContext());
        tab.setFocusable(true);
        tab.setText(title);

        tab.textView.setTextSize(tabTextSize);
        tab.setFocusable(true);
        tab.setGravity(Gravity.CENTER);
