...
public class NotificationView extends LinearLayout {
    ...
    public PictureImplCircleImageView avatarImage;
    ...
    protected void onFinishInflate() {
        ...
        avatarImage = (PictureImplCircleImageView) findViewById(R.id.avatar_image);
    ...
    public void show(MessageObject object) {
        TLRPC.User user = MessagesController.getInstance().users.get(object.messageOwner.getJid());
        TLRPC.Chat chat = null;
        long dialog_id = object.messageOwner.getId();
        /*if (object.messageOwner.get.chat_id != 0) {
