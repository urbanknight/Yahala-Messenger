...
public class ColorPickerView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        mColorWheelThickness = OSUtilities.dp(8);
        mColorWheelRadius = OSUtilities.dp(124);
        mPreferredColorWheelRadius = mColorWheelRadius;
        mColorCenterRadius = OSUtilities.dp(54);
        mPreferredColorCenterRadius = mColorCenterRadius;
        mColorCenterHaloRadius = OSUtilities.dp(60);
        mPreferredColorCenterHaloRadius = mColorCenterHaloRadius;
        mColorPointerRadius = OSUtilities.dp(14);
        mColorPointerHaloRadius = OSUtilities.dp(18);
