...
public abstract class CircleImageView extends ImageView {
    ...
    public void setBottomCircleIndent(int value) {
        if (mBottomCircleIndent == value) {
            return;
        }
        mBottomCircleIndent = value;
        invalidate();
    }

    public void setMiddleCircleIndent(int value) {
        if (mMiddleCircleIndent == value) {
            return;
        }
        mMiddleCircleIndent = value;
        invalidate();
    }

    public void setBottomCircleOnColor(int value) {
        if (mBottomCircleOnColor == value) {
            return;
        }
        mBottomCircleOnColor = value;
        invalidate();
    }

    public void setBottomCircleOffColor(int value) {
        if (mBottomCircleOffColor == value) {
            return;
        }
        mBottomCircleOffColor = value;
        invalidate();
    }

    public void setMiddleCircleOnColor(int value) {
        if (mMiddleCircleOnColor == value) {
            return;
        }
        mMiddleCircleOnColor = value;
        invalidate();
    }

    public void setMiddleCircleOffColor(int value) {
        if (mMiddleCircleOffColor == value) {
            return;
        }
        mMiddleCircleOffColor = value;
        invalidate();
    }
