...
public class PhotoPickerActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (fragmentView == null) {
            ...
            mToolbar.setTitle(LocaleController.getString("Gallery", R.string.Gallery));
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    if (selectedAlbum == null) {
                        ...
                        mToolbar.setTitle(selectedAlbum.bucketName);
                        fixLayoutInternal();
                    } else {
    ...
    public void didReceivedNotification(int id, Object... args) {
        ...
        if (id == MediaController.albumsDidLoaded) {
            //FileLog.e("albumsDidLoaded", "albumsDidLoaded");
    ...
    public PhotoViewer.PlaceProviderObject getPlaceForPhoto(MessageObject messageObject, TLRPC.FileLocation fileLocation, int index) {
        ...
        for (int a = 0; a < count; a++) {
            ...
            BackupImageView2 imageView = (BackupImageView2) view.findViewById(R.id.media_photo_image);
            if (imageView != null) {
    ...
    private void sendSelectedPhotos() {
        FileLog.e("Photo picker", "sendSelectedPhotos");
        if (selectedPhotos.isEmpty() || delegate == null || sendPressed) {
            FileLog.e("Photo picker", "selectedPhotos.isEmpty()");
            return;
        }
        sendPressed = true;
        ...
        FileLog.e("Photo picker", "didSelectPhotos");
        finishFragment();
    }
  /*  private void sendSelectedPhotos() {
        if (selectedPhotos.isEmpty() || delegate == null || sendPressed) {
    ...
    private void fixLayoutInternal() {
        ...
        itemWidth = (getParentActivity().getResources().getDisplayMetrics().widthPixels - ((columnsCount + 1) * OSUtilities.dp(4))) / columnsCount;
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
               ...
               /*ImageLoaderInitializer.getInstance().initImageLoader(R.drawable.user_blue,100,100);
                ImageTag tag = ImageLoaderInitializer.getInstance().imageTagFactory.build(albumEntry.coverPhoto.path,ApplicationLoader.applicationContext);
                imageView.setTag(tag);*/

                // ImageLoader.getInstance().DisplayImage(albumEntry.coverPhoto.path, imageView);
                //ImageLoaderInitializer.getInstance().getImageLoader().getLoader().load(imageView);
                ...
                // ImageLoader.getInstance().DisplayImage(photoEntry.path,imageView);
            }
            return view;
        }
