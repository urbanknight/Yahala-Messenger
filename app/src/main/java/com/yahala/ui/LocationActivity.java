...
public class LocationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (fragmentView == null) {
            ...
            avatarImageView = (CircleImageView) fragmentView.findViewById(R.id.location_avatar_view);
            ...
            if (googleMap != null) {
                ...
                if (messageObject != null) {
                    ...
                    if (messageObject.messageOwner.getOut() == 1) {
                        avatarImageView.setImageBitmap(ImageLoader.getInstance().loadImageSync("file:///" + UserConfig.clientUserPhoto));
                        nameTextView.setText(Utilities.formatName(UserConfig.currentUser.first_name, UserConfig.currentUser.last_name));
                    } else {
                        TLRPC.User user = ContactsController.getInstance().friendsDict.get(messageObject.messageOwner.getJid());
                        if (user != null) {
                    ...
                    userLocation = new Location("network");
                    userLocation.setLatitude(messageObject.messageOwner.tl_message.media.geo.lat);
                    userLocation.setLongitude(messageObject.messageOwner.tl_message.media.geo._long);
                    LatLng latLng = new LatLng(userLocation.getLatitude(), userLocation.getLongitude());
    ...
    private void updateUserData() {
        if (messageObject != null && avatarImageView != null) {
            String fromId = messageObject.messageOwner.tl_message.from_id;
           /* if (messageObject.messageOwner instanceof TLRPC.TL_messageForwarded) {
                fromId = messageObject.messageOwner.fwd_from_id;
            }*/
            TLRPC.User user = ContactsController.getInstance().friendsDict.get(fromId);
            if (user != null) {
