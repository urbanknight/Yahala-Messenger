...
public class Emoji {
    ...
    static {
        if (OSUtilities.density <= 1.0f) {
            emojiFullSize = 30;
        } else if (OSUtilities.density <= 1.5f) {
            emojiFullSize = 45;
        } else if (OSUtilities.density <= 2.0f) {
            emojiFullSize = 60;
        } else {
            emojiFullSize = 90;
        }
        drawImgSize = OSUtilities.dp(20);
        bigImgSize = OSUtilities.dp(30);
